...
public class
NavigationElement extends PageObject {

    public static By HOME_ICON = By.xpath("//ul[@class='menu-header']/li[1]/a");
    public static By GROUP_ICON = By.xpath("//li[@class='step-group']/a");
    public static By MESSENGER_ICON = By.xpath("//li[@class='step-messenger']/a");
    public static By NOTIFICATION_BADGE = By.xpath("//span[@class='notification-badge']");
    public static By NOTIFICATION_MENU = By.xpath("//li[@class='hide_mobile']//a");
